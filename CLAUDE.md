...
- [stdlib-string.md](./stdlib-string.md) — trim split join len lines chars contains replace index_of starts_with? is_digit? pad_right strip_prefix ...
- [stdlib-list.md](./stdlib-list.md) — get get_or first last len sort sort_by map flat_map filter find fold enumerate zip flatten take drop chunk unique join sum min max ...
- [stdlib-map.md](./stdlib-map.md) — new get set contains remove merge keys values entries from_list is_empty? ...
- [stdlib-fs.md](./stdlib-fs.md) — read_text write read_lines append mkdir_p exists? is_dir? is_file? remove list_dir copy rename ...
- [stdlib-io.md](./stdlib-io.md) — path env process io println ...
- [stdlib-int.md](./stdlib-int.md) — int.to_string to_hex parse parse_hex abs min max band bor bxor bshl bshr wrap_add wrap_mul float.from_int ...
- [stdlib-json.md](./stdlib-json.md) — parse stringify get get_string get_int get_array keys ...
- [stdlib-extra.md](./stdlib-extra.md) — math random time regex encoding args
